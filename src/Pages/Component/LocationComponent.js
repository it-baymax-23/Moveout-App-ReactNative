...
class LocationComponent extends Component
{
    ...
    gettitle = (value) => {
        ...
        {
            itemarray.push(value[item].count + " " + value[item].label);
        }
                ...
                <TouchableOpacity style={style.container} onPress={()=>this.props.active(this.props.data.guid)}>
                    <View style={{flexDirection:"row"}}>
                        ...
                        <View style={style.state}>
                            <TouchableOpacity style={!this.props.data.active?style.accepticon:style.acceptedicon}></TouchableOpacity>
                            <Text style={!this.props.data.active?style.accepttext:style.acceptedtext}>{this.props.data.active?'Aceito':'Em Processo'}</Text>
                        </View>
                    </View>
                    <View>
                        ...
                        <View style={style.movecontainer}>
                            ...
                            <View style={{marginTop:13}}>
                                ...
                                <Text style={{fontSize:hp('1.9%'),color:'#5666F9'}}>
                                   {
                                       this.gettitle(this.props.data.value)
                                   }
                                </Text>
                            </View>
