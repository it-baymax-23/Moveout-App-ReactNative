...
class UpdateProfile extends Component
{
    ...
    signup = () => {
        ...
        if(this.state.profileupdate && user.profile)
        {
            this.uploadimage(user.profile,function(data){
                user.profile = data;
                ...
                <KeyboardAvoidingView behavior="padding" style={{flex:1}} >
                    <ScrollView style={style.container}>
                        ...
                        <TouchableOpacity style={style.profile} onPress={this.pickimage}>
                            ...
                            <Image style={style.profileimage} source={this.state.user.profile?{uri:this.state.user.profile}:require('../../img/profile/profile.png')}></Image>
                        ...
                        <View style={style.form}>
                            ...
                            <View style={style.row}>
                                ...
                                <TextInput style={style.cpftext} defaultValue={this.state.user.cpf} onChangeText={(text)=>this.handleChange("cpf",text)}></TextInput>
                            </View>
                        </View>
