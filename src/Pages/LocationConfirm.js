    ...
    render()
    {
        ...
        return (
            <CheckoutLayout {...this.props}>
                ...
                <Text style={style.description}>Resumo da sua mudança 😊</Text>
                <View style={{marginTop:hp('3.94%')}}>
                    <LocationConfirmComponent {...this.props} data={this.props.navigation.state.params.params}></LocationConfirmComponent>
                </View>
